...
const entries = [
	...
	},
	{
		...
		register: async (program) => {
			(await import("./gateway-cli-BcCUuVIr.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./models-cli-ChfH83F9.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./hooks-cli-CeD1Fe4_.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./plugins-cli-PoFHEz8f.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-DXQIrPl8.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		register: async (program) => {
			(await import("./channels-cli-DOzsYRXN.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./update-cli-CfOgdD_k.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		register: async (program) => {
			(await import("./completion-cli-Ce1bP-NF.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
