...
import { H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, W as normalizeVerboseLevel } from "./pi-embedded-helpers-BErwuGYF.js";
import { At as getRemoteSkillEligibility, Cn as AGENT_LANE_NESTED, I as resolveOutboundTarget, L as resolveSessionDeliveryTarget, On as registerAgentRunContext, Sr as applyVerboseOverride, Tn as emitAgentEvent, Ut as getSkillsSnapshotVersion, V as runWithModelFallback, Vr as resolveAgentTimeoutMs, br as clearSessionAuthProfileOverride, i as runCliAgent, l as runEmbeddedPiAgent, n as getCliSessionId, r as setCliSessionId, s as resolveSendPolicy, wn as clearAgentRunContext, xr as applyModelOverrideToSessionEntry, yr as lookupContextTokens } from "./reply-4ZmPSA9o.js";
import { d as resolveAgentIdFromSessionKey, l as normalizeAgentId, u as normalizeMainKey } from "./session-key-BWxPj0z_.js";
import { a as resolveAgentModelPrimary, i as resolveAgentModelFallbacksOverride, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, x as ensureAgentWorkspace } from "./agent-scope-C6CjuRmH.js";
import { Ct as ensureAuthProfileStore, Ft as DEFAULT_CONTEXT_TOKENS, It as DEFAULT_MODEL, Lt as DEFAULT_PROVIDER, a as isCliProvider, d as resolveConfiguredModelRef, h as resolveThinkingDefault, o as modelKey, t as buildAllowedModelSet } from "./model-selection-CAeh1IIE.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { i as loadConfig } from "./config-Bp4ZzxPF.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-DsO8Iwb1.js";
import { C as resolveChannelResetConfig, S as evaluateSessionFreshness, T as resolveSessionResetType, i as loadSessionStore, j as resolveExplicitAgentSessionKey, l as updateSessionStore, v as normalizeAccountId, w as resolveSessionResetPolicy, x as resolveSessionKey } from "./sessions-Bb7OTD70.js";
import { s as loadModelCatalog } from "./runner-CwwbBOHe.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-rhZUKavR.js";
...
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-CLIT4blf.js";
...
function createDefaultDeps() {
	return {
		sendMessageWhatsApp: async (...args) => {
			const { sendMessageWhatsApp } = await import("./web-DZaTo4-o.js");
			return await sendMessageWhatsApp(...args);
		},
		sendMessageTelegram: async (...args) => {
			const { sendMessageTelegram } = await import("./send-NHWbup9s.js").then((n) => n.s);
			return await sendMessageTelegram(...args);
		},
		sendMessageDiscord: async (...args) => {
			const { sendMessageDiscord } = await import("./send-CrLP587C.js").then((n) => n.t);
			return await sendMessageDiscord(...args);
		},
		sendMessageSlack: async (...args) => {
			const { sendMessageSlack } = await import("./send-AkhdWJTp.js").then((n) => n.n);
			return await sendMessageSlack(...args);
		},
		sendMessageSignal: async (...args) => {
			const { sendMessageSignal } = await import("./send-CheZW9ZZ.js").then((n) => n.i);
			return await sendMessageSignal(...args);
		},
		sendMessageIMessage: async (...args) => {
			const { sendMessageIMessage } = await import("./send-BI15gv7b.js").then((n) => n.n);
