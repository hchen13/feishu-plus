...
import { n as resolveOpenClawPackageRootSync, t as resolveOpenClawPackageRoot } from "./openclaw-root-CEnmuBUN.js";
import { c as resolveDefaultAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, s as resolveAgentWorkspaceDir } from "./agent-scope-C6CjuRmH.js";
import { t as isTruthyEnvValue } from "./env-BSjH4KuP.js";
import { _ as parseDurationMs, i as loadConfig } from "./config-Bp4ZzxPF.js";
import { f as resolvePreferredAccountId, n as listChannelPlugins, t as getChannelPlugin, u as buildChannelAccountBindings } from "./plugins-DsO8Iwb1.js";
import { A as resolveAgentMainSessionKey, i as loadSessionStore, k as canonicalizeMainSessionAlias, l as updateSessionStore, s as saveSessionStore } from "./sessions-Bb7OTD70.js";
import { n as formatErrorMessage } from "./errors-BeAy8PFi.js";
import { c as resolveStorePath } from "./paths-BuQbsACT.js";
import { C as HEARTBEAT_TOKEN, t as deliverOutboundPayloads } from "./deliver-CLIT4blf.js";
...
import { a as resolveIndicatorType, n as emitHeartbeatEvent, o as appendCronStyleCurrentTimeLine, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-CEj2dtuo.js";
...
async function runHeartbeatOnce(opts) {
	...
	try {
		if (isHeartbeatContentEffectivelyEmpty(await fs$1.readFile(heartbeatFilePath, "utf-8")) && !isExecEventReason && !isCronEventReason && !isWakeReason) {
			emitHeartbeatEvent({
				status: "skipped",
