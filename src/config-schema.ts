...
const MilestoneContextSchema = z
  .object({
    enabled: z.boolean().optional(),
 ...
 * - task and sheet are local extension additions kept for backward compatibility
 */
const FeishuToolsConfigSchema = z
  .object({
    ...
    sheet: z.boolean().optional(), // Spreadsheet operations (default: true)
  })
  .strict()
  .optional();
...
export const FeishuConfigSchema = z
  .object({
    ...
    // Group milestone tracking + context injection retained from local plugin
    milestoneContext: MilestoneContextSchema,
    // Optimization flags
